<?php
/**
 * LMLA Theme functions and definitions.
 *
...
add_action( 'after_setup_theme', 'lmla_setup' );
...
add_action( 'widgets_init', 'lmla_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'lmla_scripts' );
