...
// Programs Custom Post Type
	...
	// Teachers and Staff Custom Post Type
		$labels = array(
			'name'                  => 'Teachers & Staff',
			'singular_name'         => 'Teachers & Staff',
			'menu_name'             => 'Teachers & Staff',
			'name_admin_bar'        => 'Teachers & Staff',
			'archives'              => 'Teachers & Staff Archives',
			'parent_item_colon'     => 'Parent Teachers & Staff:',
			'all_items'             => 'All Teachers & Staff',
			'add_new_item'          => 'Add New Teachers & Staff',
			'add_new'               => 'Add New',
			'new_item'              => 'New Teachers & Staff',
			'edit_item'             => 'Edit Teachers & Staff',
			'update_item'           => 'Update Teachers & Staff',
			'view_item'             => 'View Teachers & Staff',
			'search_items'          => 'Search Teachers & Staff',
			'not_found'             => 'Not found',
			'not_found_in_trash'    => 'Not found in Trash',
			...
			'insert_into_item'      => 'Insert into teachers & staff',
			'uploaded_to_this_item' => 'Uploaded to this teachers & staff',
			'items_list'            => 'Teachers & Staff list',
			'items_list_navigation' => 'Teachers & Staff list navigation',
			'filter_items_list'     => 'Filter teachers & staff list',
		);
		$args = array(
			'label'                 => 'Teachers & Staff',
			'description'           => 'Teachers & Staff for Little Mountain',
			'labels'                => $labels,
			'supports'              => array('title', 'editor', 'author', 'thumbnail', 'revisions', ),
			'hierarchical'          => false,
			'public'                => true,
